...
function addQuestion(){
    ...
    questionLabel.innerHTML = "Soru " + String(questionNum) + ": ";
    questionField.setAttribute('class', 'question');
    questionField.setAttribute('id', 'q' + String(questionNum));
    questionField.setAttribute('type', 'text');
    
    answer1Label.innerHTML = "Cevap 1: ";
    answer2Label.innerHTML = "Cevap 2: ";
    answer3Label.innerHTML = "Cevap 3: ";
    answer4Label.innerHTML = "Cevap 4: ";
    correctLabel.innerHTML = "Doğru Cevap (1-4): ";
...
function cancelQuiz(){
    if (confirm("Çıkmak istediğinizden eminmisiniz? Bütün çalışmalarınız silinecek !")) {
...
function randomColor(){
    ...
    var colors = ['#a40000', '#ee4000', '#ffd700', '#228b22','#0000ee','#00f5ff','#a40000','#228b22','#ffd700','#ee4000'];
